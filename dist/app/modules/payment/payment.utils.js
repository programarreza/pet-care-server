...
const initiatePayment = (paymentData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield axios_1.default.post(config_1.default.payment_url, {
            ...
            success_url: `${config_1.default.base_url}/api/v1/payments/confirmation?transactionId=${paymentData.transactionId}&status=success`,
            fail_url: `${config_1.default.base_url}/api/v1/payments/confirmation?status=failed`,
